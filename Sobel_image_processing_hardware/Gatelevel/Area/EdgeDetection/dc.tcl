...
set Dump_file_name "Edge_Detection_syn"
#設定Top module 名稱，需跟自行設計之電路的top module name相同
set Top				"Edge_Detection"
...
# current_design $Top
analyze -format verilog { 	/home/B103040012_HDL/HDL/HW4/RTL/Conv.v 
                            /home/B103040012_HDL/HDL/HW4/RTL/Intensity.v
                            /home/B103040012_HDL/HDL/HW4/RTL/LineBuffer.v
                            /home/B103040012_HDL/HDL/HW4/RTL/edge_detection.v
                        }
elaborate $Top
...
uplevel #0 { report_timing  -through { step0/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s0_timing_report.txt}
