...
1. Reads the input image data.
2. Reads the convolution weights and biases.
3. Applies zero-padding.
4. Sends input feature maps, weights, and biases to the RTL modules.
5. Captures the convolution outputs.
6. Applies output scaling and bit extraction for image generation.
7. Writes the Conv1 and Conv2 output feature maps as image files.
