...
uplevel #0 { report_timing  -through { step1/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/timing_report_stage1.txt
uplevel #0 { report_timing  -through { step2/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/timing_report_stage2.txt
uplevel #0 { report_timing  -through { step3/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/timing_report_stage3.txt
uplevel #0 { report_timing  -through { step4/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/timing_report_stage4.txt
