...
set Path_Top		"/home/M133040086_HDL/HW3/rtl/"
set Path_Syn		"/home/M133040086_HDL/HW3/syn/"
set Dump_file_name  "IF_syn"
...
/home/M133040086_HDL/HW3/rtl/thumb_pipe.v
/home/M133040086_HDL/HW3/rtl/IF.v
}
elaborate $Top
...
uplevel #0 { report_timing  -through { stage1/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/timing_report_stage1.txt
uplevel #0 { report_timing  -through { stage2/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/timing_report_stage2.txt
uplevel #0 { report_timing  -through { stage3/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/timing_report_stage3.txt
uplevel #0 { report_timing  -through { stage4/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } > $Path_Syn/timing_report_stage4.txt
