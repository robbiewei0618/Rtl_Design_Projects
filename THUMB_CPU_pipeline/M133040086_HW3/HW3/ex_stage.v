module EX(
    ...
    input [5:0] ID_opcode,
    input [`WORD_SIZE-1:0] ID_Rd, 
    input [`WORD_SIZE-1:0]ID_Rn, 
    input [`WORD_SIZE-1:0]ID_Rm_Rs,
    input [10:0] ID_imm_offset,
...
always @(negedge reset_n or posedge clk) begin
    if (~reset_n) begin
      ...
      EX_imm_offset <= 11'b00_0000_0000;
      EX_opcode <= 6'b00_0000;
      EX_Rd_code <= 3'b000;
    end
